...
list.addEventListener("click", (event)=>{
    ...
    if (event.target.classList.contains("delete")) deleteBookmark(index);
    else if (event.target.classList.contains("edit")) editBookmark(index);
}); // const input = document.getElementById("bookmarkInput");
 // const addBtn = document.getElementById("addBookmarkBtn");
 // const list = document.getElementById("bookmarkList");
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire42e4", {})

//# sourceMappingURL=d.z.json.0f77c784.js.map
